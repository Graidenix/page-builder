...
const NavBar: React.FC<NavBarProps> = (props) => {
    ...
    return (
        <nav id="header" className="w-full z-30 top-0 py-1 h-12">
            <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6">
                ...
                <div className="order-1 md:order-2">
                    <a className="flex items-center tracking-wide no-underline hover:no-underline font-bold text-main-10 text-xl "
                       href="#">
                        {logo}
                    </a>
                </div>
